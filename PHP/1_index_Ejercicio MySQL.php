...
<body>
    ...
    <div class="container">
        ...
        <h2 align="center">FASE4 EJERCICIO SCRIPT SQL</h2>
                    ...
                    <thead align="center">
                        <tr>
                            <th colspan="5" scope="col">
                                SCRIPT CONSULTA DE UNA BASE DE DATOS
                            </th>
                        </tr>
                    </thead>
                    <tbody align="center">
                            ...
                            <td align="left"><b>
                               ...
                               <?php 
                                if (isset($_POST["submit"])) {
                                    ...
                                    $sql = "SELECT Codigo, Fecha, Lugar, Entrevistador FROM entrevistas";
                                    $result = $conn->query($sql);
                                    
                                    if ($result->num_rows > 0) {
                                        // output data of each row
                                        while($row = $result->fetch_assoc()) {
                                            echo "<br> Codigo: ". $row["Codigo"]. " Fecha:". $row["Fecha"]. " Lugar:" .$row["Lugar"]. " Entrevistador: " .$row["Entrevistador"]. "<br>";
                                        }
                                    } else {
                                        echo "0 results";
                                    }
