...
<body>
    ...
    <div class="container">
        ...
        <?php
                    ...
                    include '4_SQL clase.php';
                    $Datos = array ("Consulta","eMail","Apellidos","Nombre");
...
//--------------------------------------------------------------------------------------->
        ...
        <form action="4_SQL variables.php" method="POST">
            ...
            <div>
                <table id="cotiza" class="table table-sm table-dark">
                    ...
                    <tbody align="center">
                        ...
                        <tr>
                            <td><b>DATOS DE CONTACTO:</td>
                            <td align="left"><b>

                                    <?php        
              
                                    $ElementosFrm = new elementsCtrlFrm();
                                    echo $ElementosFrm-> CrearInput($Datos,"Input");
